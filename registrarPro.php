                ...
                <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                    <div class="card mb-5">
                        <div class="card-body p-sm-5">
                            <h2 class="text-center mb-4">Crear una Cuenta Pro!</h2>
                            <form method="post">
                                <div class="mb-3"><input class="form-control" type="text" id="name-2" name="nombre" placeholder="Nombre y Apellidos"></div>
                                <div class="mb-3"><input class="form-control" type="email" id="email-2" name="correo" placeholder="Correo Electrónico"><input class="form-control" type="password" id="email-1" name="clave" placeholder="Contraseña" style="margin-top: 12px;"></div>
                                <div class="mb-3"></div>
                                <div><button class="btn btn-primary d-block w-100" type="submit">Crear cuenta</button><a class="btn btn-danger d-block w-100" role="button" href="cuenta.html" style="margin-top: 7px;">Cancelar</a></div>
                            </form>
                        </div>
                    </div>
                </div>
