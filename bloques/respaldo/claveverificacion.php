...
if($_POST) {
    ...
    if($cod==$codigo_usuario) {
        ...
        header("Location: nuevaclave.php?email=".$email_paquete);

    } else {

        ?><script>
            alert("Error: clave de verificacion incorrecta");
        </script><?php
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <div class="alert alert-success" role="alert"><span><strong>Revise su correo electrónico, </strong>se ha enviado el código a <strong><?php echo($txtEmail); ?>&nbsp;</strong><br></span></div>
                                    </div>
                                    <form method="post" class="user">
                                        ...
                                        <button class="btn btn-primary d-block btn-user w-100" type="submit" role="button">Acceder</button>
                                    </form>
