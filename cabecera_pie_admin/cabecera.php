                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                ...
                                <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                    ...
                                    <img class="rounded-circle mb-3 mt-4" src="../../../../bloques/admin/cuenta/<?php echo $registro['logo_agencia']; ?>" width="45" height="45" style="margin-left: 1px;margin-bottom: 45px;margin-top: 46px;"></a>
